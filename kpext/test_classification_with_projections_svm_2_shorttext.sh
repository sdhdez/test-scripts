...
EVAL_RESULTS_FILE="evaluation_results_tmp.dat"$7;
...
do
    ...
    then
        ...
        then
            ...
            python kp_svm_with_projection_two_classes_with_shorttext.py $TRAIN_DIR $PROJECTION $FULL_NEW_PATH $MIN_SIMILARITY $DEBUG;
